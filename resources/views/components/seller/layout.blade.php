...
<html>
<head>
<title>Seller Pannel for eshop</title>
   ...
   <!--/content-inner-->
	<div class="left-content">
	   <div class="inner-content">
		<!-- header-starts -->
						...
						<div class="top_menu">
						        <div class="main-search">
											<form method="GET" action="{{ route('seller_search') }}">
											   <input name="search" type="text" placeholder="Search products here..." value="Search" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Search';}" class="text"/>
												<input type="submit" value="">
											</form>
									<div class="close"><img src="/seller/images/cross.png" /></div>
								</div>
           ...
           <!--//outer-wp-->
            ...
            <div class="sidebar-menu">
                <header class="logo">
                <a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>Seller Pannel</h1></span> 
        ...
        <!--/down-->
                        <div class="down">	
                                  <a href="index.html"><img src="/seller/images/admin.jpg"></a>
                                ...
                                <li><a class="tooltips" href="index.html"><span>Profile</span><i class="lnr lnr-user"></i></a></li>
									...
									<li><form method="POST" action="{{ route('logout') }}">
										@csrf
										<a href="{{ route('logout') }}" class="tooltips"  onclick="event.preventDefault();
										this.closest('form').submit();"><span>Log out</span><i class="lnr lnr-power-switch"></i></a>
									  </form></li> 
                                    </ul>
                                </div>
                           <!--//down-->
                       <div class="menu">
                                <ul id="menu" >
                                    <li><a href="{{route('seller_index')}}"><i class="fa fa-home"></i> <span>Home</span></a></li>
                                    <li><a href="{{route('seller_dashboard')}}"><i class="fa fa-tachometer"></i> <span>Dashboard</span></a></li>
